...
console.log("Срок :" , SROKITOG, "Дней");
	alert("Цена : " + SUMITOG + " Рублей" + "        Срок : " + SROKITOG + " Дней");
	}
else
	{
		console.log(".");
		...
		alert("Вы Наверное написали где-то неправильно или пропустили один из пунктов... Можете перезагрузить сайт и начать заново");
	}
